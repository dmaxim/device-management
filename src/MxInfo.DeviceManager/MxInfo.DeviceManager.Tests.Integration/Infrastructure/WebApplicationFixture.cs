...
public class WebApplicationFixture : IDisposable
{
    ...
    private const string HostName = "deviceManagerApp";
    ...
    private async Task InitializeAppHost()
    {
        ...
        await _deviceManagerApiApp.ResourceNotifications.WaitForResourceHealthyAsync(HostName, DefaultCancellationToken).WaitAsync(DefaultTimeout, DefaultCancellationToken);
    }
